  ...
  return (
    <div className="flex-none  bg-black h-screen min-w-[25%] fixed ">
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/miusarname", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.instagram.com/oscarmalvarezgomez/", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/oscar-mauricio-alvarez-g%C3%B3mez-280471217",
              "_blank"
            )
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.facebook.com/oscarm.alvarezgomez.9", "_blank")
          }
        >
