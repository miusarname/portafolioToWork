      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Oscar Alvarez,</span> a cross-platform fullstack developer
          </h3>
          <p
            className="pt-5 leading-7 text-slate-900 text-justify"
            data-aos={"fade-left"}
          >
            Hello! I'm Oscar, a passionate cross-platform programmer with knowledge in various technologies, including TypeScript, Flutter, Python, and C. Throughout my career, I've enjoyed working on various projects ranging from mobile apps to backend solutions.
          </p>
          <p
            className="text-justify leading-7 text-slate-900"
            data-aos={"fade-right"}
          >
            I strive to write clean, modular, and well-documented code. Troubleshooting and optimization are aspects that I always keep in mind when working on a project.
          </p>
        </div>
