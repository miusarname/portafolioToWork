      ...
      <div className="grid grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold  text-white ml-28">
              Curso Docker - Codigo Facilito
            </h3>
            <time class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
              Completed on Jun 7th, 2023
            </time>
            <p class="mb-4 text-base font-normal  text-gray-400">
            Docker is a platform that enables developers to build, ship, and run applications and services in containers. Containers are lightweight, standalone executable units that package the application code, libraries, and dependencies required to run it. The primary advantages of Docker are portability, scalability, and consistency across different environments.
            </p>
            <a
              href="https://codigofacilito.com/certificates/81563"
              target="_blank"
              rel="noreferrer"
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            <a
              href="https://www.freecodecamp.org/espanol/certification/fcc5a7abfd0-c07f-41dc-8735-7b4d074cf8a0/back-end-development-and-apis"
              target="_blank"
              rel="noreferrer"
          ...
          <li data-aos="zoom-in" data-aos-offset={"-15"} data-aos-delay="1300">
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://freecodecamp.org/espanol/certification/fcc5a7abfd0-c07f-41dc-8735-7b4d074cf8a0/front-end-development-libraries "
              class="inline-flex items-center px-4 py-2 mt-5 text-sm font-medium border rounded-lg focus:z-10 focus:ring-4 focus:outline-none focus:text-blue-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 focus:ring-gray-700"
            >
              <svg
                class="w-4 h-4 mr-2"
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            ...
            <BarGraph name={"PHP"} percent={75} />
            <BarGraph name={"HTML/CSS"} percent={80} />
            <BarGraph name={"SQL"} percent={70} />
            <BarGraph name={"Python"} percent={65} />
            <BarGraph name={"Dart"} percent={55} />
          </div>

          <a
            href={require("../../assets/files/Profile.pdf")}
            download={"Oscar's Resume"}
